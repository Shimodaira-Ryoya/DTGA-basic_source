...
def main(title='rootextention[cartlow6secpara4]', seedlist=[1,2,3,4,5], 
         dataname='digits', tr_size=1300, dataset_seed=1, 
         ngen=100, psize=100, pc=1, nvm=1, clones=False, vhigh=0.3,
         mkbit=10,evbit=10,plow_mk=0.6,phigh_mk=0.9,plow_ev=0.9,phigh_ev=0.9,ev_per=0.3,
         secpara=3,cartlow=6,
         AC=1,SZ=1,MT=0,TS=0,
